...
class GameMap:
    ...
    def render(self, console: Console) -> None:
        ...
        for entity in entities_sorted_for_rendering:            # Only print entities that are in the FOV
...
class GameWorld:
    """
    Holds the settings for the GameMap, and generates new maps when moving up/down the stairs.
    """
